'''
Author: your name
Date: 2021-08-12 18:15:24
LastEditTime: 2021-08-13 17:32:16
LastEditors: Please set LastEditors
Description: In User Settings Edit
FilePath: /GC-Net/GCNET/gc_net.py
'''
import torch
...
def loss(xx,loss_mul,gt):
    loss=torch.sum(torch.sqrt(torch.pow(torch.sum(xx.mul(loss_mul),-1)-gt,2)+0.0000000001)/256/(256+128))
    return loss
