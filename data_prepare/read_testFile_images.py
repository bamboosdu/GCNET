...
dir_flying='/workspace/data_aanet/SceneFlow/FlyingThings3D/frames_cleanpass/TEST'
paths=[]
...
foutl=open('dataset/paths_left_test.pkl','wb')
foutr=open('dataset/paths_right_test.pkl','wb')
